...
\begin{exercise}[Stelling met bewijs]
    Voeg een stelling met bewijs (\mintinline{tex}{\begin{proof}}) toe in je bestand.
...
\begin{exercise}[Stelsel in matrix]
    ...
    %     AAA
    %   \end{cutout}
Stelsels lineaire vergelijkingen kunnen opgelost worden door ze te schrijven als
een matrix en Gauss-eliminatie toe te passen.
