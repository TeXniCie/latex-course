...
\declaretheorem[style=definition,name=Oefening]{exercise} % If you want your theorems to be counted per section instead of subsection, then just remove the sub from the numberwithin
