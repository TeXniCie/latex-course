...
\declaretheorem[style=uprightIndentedNoNewline,name={\rlap{\hspace{0.75pt}\raisebox{1.5pt}{x}}\ensuremath{\square} Oefening}]{exercise} % If you want your theorems to be counted per section instead of subsection, then just remove the sub from the numberwithin
