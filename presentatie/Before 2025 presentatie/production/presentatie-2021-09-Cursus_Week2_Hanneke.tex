...
\frametitle{Verschil in opmaak}
	\begin{tabular}{c c}
		\fbox{\includegraphics[width=0.4\textwidth]{voorbeeldweek1.pdf}}
		& \fbox{\includegraphics[width=0.4\textwidth, page=2]{voorbeeldweek2.pdf}}
	\end{tabular}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
			\includegraphics[height=0.9\textheight]{Layout-dimensions.png}
