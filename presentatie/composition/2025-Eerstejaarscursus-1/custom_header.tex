...
{%
    ...
    \begin{beamercolorbox}{section in head/foot}
        ...
        \adjustbox{
            ...
            \hyperlink{eerste_document}{\customhead{2}{Eerste document}}%
        ...
        \adjustbox{
            ...
            \hyperlink{commands}{\customhead{3}{LaTeX commands}}%
            % \hspace{5pt}$ \cdot $\hspace{5pt}%
            % \hyperlink{figures}{\customhead{5}{Figures}}%
            % \hspace{5pt}$ \cdot $\hspace{5pt}%
        ...
        \adjustbox{
            ...
            \hyperlink{math_mode}{\customhead{4}{Math mode}}%
            % \hspace{5pt}$ \cdot $\hspace{5pt}%
            % \hyperlink{figures}{\customhead{5}{Figures}}%
            % \hspace{5pt}$ \cdot $\hspace{5pt}%
            % \hyperlink{tabellen}{\customhead{8}{Tabellen}}%
        ...
        \adjustbox{
            ...
            \hyperlink{plaatjes}{\customhead{5}{Plaatjes}}%
            % \hspace{5pt}$ \cdot $\hspace{5pt}%
            % \hyperlink{figures}{\customhead{5}{Figures}}%
            % \hspace{5pt}$ \cdot $\hspace{5pt}%
            % \hyperlink{tabellen}{\customhead{8}{Tabellen}}%
